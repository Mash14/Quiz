...
function Politics() {
    ...
    useEffect(()=>{
        if(questionType === 'easy') {
            fetch('https://opentdb.com/api.php?amount=10&category=24&difficulty=easy&type=multiple')
            ...
            fetch('https://opentdb.com/api.php?amount=10&category=24&difficulty=hard&type=multiple')
                .then(response => response.json())
                .then(res => setQuestions(res.results))
        }      
